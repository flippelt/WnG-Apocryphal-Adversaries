...
| Heretic Astartes | Heretic Astartes — **v1.1** (1/6/2024) | v0.9.8 (Thousand Sons) | 🔧 in progress — base legion (71 actors + 52 items, v0.9.1), **Death Guard → v0.9.4** (17 actors + 40 items), **Emperor's Children → v0.9.6** (3 actors + 12 items), **Thousand Sons → v0.9.8** (12 actors + 68 items: Discipline of Change/Vengeance, Cult Psychic Powers, Adversary Traits, Sorcerous Arcana); remaining World Eaters → **v1.0.0** (= final legion + all factions complete) |

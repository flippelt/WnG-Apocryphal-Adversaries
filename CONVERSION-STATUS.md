...
| Heretic Astartes | Heretic Astartes — **v1.1** (1/6/2024) | v0.9.1 (base) | 🔧 in progress — base legion done (71 actors + 52 items, v0.9.1). Split per legion: base → v0.9.1, **Death Guard → v0.9.4**, **Emperor's Children → v0.9.6** (3 actors + 12 items); remaining Thousand Sons → v0.9.8, World Eaters → **v1.0.0** (= final legion + all factions complete) |

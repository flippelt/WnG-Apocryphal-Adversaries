...
| Heretic Astartes | Heretic Astartes — **v1.1** (1/6/2024) | v0.9.1 (base) | 🔧 in progress — base legion done (71 actors + 52 items, v0.9.1). Split per legion: base → v0.9.1; cult legions Death Guard/Emperor's Children/Thousand Sons/World Eaters ship as v0.9.x; **v1.0.0 = final legion + all factions complete** |

...
| Heretic Astartes | Heretic Astartes — **v1.1** (1/6/2024) | v1.0.0 (all 5 legions) | ✅ done — base legion (71 actors + 52 items, v0.9.1), **Death Guard → v0.9.4** (17 actors + 40 items), **Emperor's Children → v0.9.6** (3 actors + 12 items), **Thousand Sons → v0.9.8** (12 actors + 68 items), **World Eaters → v1.0.0** (8 actors + 9 items: Blood Tithe/Mark of Khorne Adversary Traits, Gore-Caked Relics). All 5 legions done; **v1.0.0 = every faction in the series complete** |
